 ...
 * @since v3.10.0
 */
class MoMo_ACG_Chatbot_Shortcodes {
	/**
	 * Constructor
	 */
	...
	public function momo_add_single_chatbot( $attributes ) {
		global $momoacg;
		$transient_id = $momoacg->chatbot->momo_chatbot_get_transient_id();
		...
		return $momoacg->chatbot->momo_acg_generate_chatbot( $attributes, $chatbot_session );
	}
}
new MoMo_ACG_Chatbot_Shortcodes();
