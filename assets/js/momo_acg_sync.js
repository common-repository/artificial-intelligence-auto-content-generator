...
jQuery(document).ready(function ($) {
    ...
    function generateImage($this, ajaxdata) {
        ...
        ajaxdata.action = 'momo_acg_openai_generate_remaining_synchronously';
        ajaxdata.security = momoacg_sync_admin.momoacg_ajax_nonce;
        ...
        $.ajax({
            beforeSend: function () {
                ...
                old += $msgBox.html();
                $msgBox.html(old + '</br>' + '<b>' + momoacg_sync_admin.mb_add_image + '</b>');
                $msgBox.show();
            },
            type: 'POST',
            dataType: 'json',
            url: momoacg_sync_admin.ajaxurl,
            data: ajaxdata,
    ...
    function generateHyperlink($this, ajaxdata) {
        ...
        $.ajax({
            beforeSend: function () {
                ...
                $working.addClass('show');
                old += $msgBox.html();
                $msgBox.html(old + '</br>' + '<b>' + momoacg_sync_admin.mb_add_hyperlink + '</b>');
                $msgBox.show();
            },
            type: 'POST',
            dataType: 'json',
    ...
    function generateConclusion($this, ajaxdata) {
        ...
        $.ajax({
            beforeSend: function () {
                ...
                $working.addClass('show');
                old += $msgBox.html();
                $msgBox.html(old + '</br>' + '<b>' + momoacg_sync_admin.mb_add_conclusion + '</b>');
                $msgBox.show();
            },
            type: 'POST',
            dataType: 'json',
    ...
    function generateIntroduction($this, ajaxdata) {
        ...
        $.ajax({
            beforeSend: function () {
                ...
                $working.addClass('show');
                old += $msgBox.html();
                $msgBox.html(old + '</br>' + '<b>' + momoacg_sync_admin.mb_add_introduction + '</b>');
                $msgBox.show();
            },
            type: 'POST',
            dataType: 'json',
    ...
    function getMomoAcgContentFromHeadings($this, ajaxdata, stage) {
        ...
        var oldmsg = '';
        oldmsg = $msgBox.html();
        $msgBox.html(oldmsg + '</br>' + '<b>' + momoacg_sync_admin.mb_add_content + '</b>');
        var xhrs = [];
        var count = 0;
        $contentBox.val('');
        $.each($headings, function (index, value) {console.log(index);console.log(value);
            ...
            ajaxdata.security = momoacg_sync_admin.momoacg_ajax_nonce;
            ajaxdata.action = 'momo_acg_openai_generate_contents_synchronously';
        ...
        $.when.apply($, xhrs).done(function () {
            ...
            $msgBox.html(oldMsg + '</br><b>' + count + ' ' + momoacg_sync_admin.completed_content_generation + '</b>').show();
    ...
    function getMomoAcgHeadings($this, ajaxdata, stage) {
        ...
        var msgbox = momoacg_sync_admin['mb_add_' + stage];
        ajaxdata.action = 'momo_acg_openai_generate_headings_synchronously';
        $.ajax({
            beforeSend: function () {
                $working.addClass('show');
    ...
    function triggerTimeCard($this) {
        ...
        var oldMsg = $msgBox.html();
        $msgBox.html(oldMsg + '</br></br><b>' + ' ' + momoacg_sync_admin.time_taken + toHoursAndMinutes(totalTime) + '</b>').show();
